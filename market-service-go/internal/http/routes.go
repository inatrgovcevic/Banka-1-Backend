...
func registerRoutes(handle func(string, string, http.Handler), cfg platform.Config, app *App, jwtService *auth.JWTService, withAuth func(string, http.Handler) http.Handler) {
	...
	add(http.MethodGet, "/price-alerts", jwtService.Middleware(auth.RequireRoles("CLIENT_BASIC", "CLIENT_TRADING", "BASIC", "AGENT", "SUPERVISOR", "ADMIN")(http.HandlerFunc(handlers.ListPriceAlerts))))
	add(http.MethodPost, "/price-alerts", jwtService.Middleware(auth.RequireRoles("CLIENT_BASIC", "CLIENT_TRADING", "BASIC", "AGENT", "SUPERVISOR", "ADMIN")(http.HandlerFunc(handlers.CreatePriceAlert))))
	add(http.MethodPatch, "/price-alerts/", jwtService.Middleware(auth.RequireRoles("CLIENT_BASIC", "CLIENT_TRADING", "BASIC", "AGENT", "SUPERVISOR", "ADMIN")(http.HandlerFunc(handlers.PriceAlertSubroutes))))
	add(http.MethodDelete, "/price-alerts/", jwtService.Middleware(auth.RequireRoles("CLIENT_BASIC", "CLIENT_TRADING", "BASIC", "AGENT", "SUPERVISOR", "ADMIN")(http.HandlerFunc(handlers.PriceAlertSubroutes))))
	add(http.MethodGet, "/watchlists", jwtService.Middleware(auth.RequireRoles("CLIENT_BASIC", "CLIENT_TRADING", "BASIC", "AGENT", "SUPERVISOR", "ADMIN")(http.HandlerFunc(handlers.ListWatchlists))))
	add(http.MethodPost, "/watchlists", jwtService.Middleware(auth.RequireRoles("CLIENT_BASIC", "CLIENT_TRADING", "BASIC", "AGENT", "SUPERVISOR", "ADMIN")(http.HandlerFunc(handlers.CreateWatchlist))))
	add(http.MethodGet, "/watchlists/", jwtService.Middleware(auth.RequireRoles("CLIENT_BASIC", "CLIENT_TRADING", "BASIC", "AGENT", "SUPERVISOR", "ADMIN")(http.HandlerFunc(handlers.WatchlistSubroutes))))
	add(http.MethodPost, "/watchlists/", jwtService.Middleware(auth.RequireRoles("CLIENT_BASIC", "CLIENT_TRADING", "BASIC", "AGENT", "SUPERVISOR", "ADMIN")(http.HandlerFunc(handlers.WatchlistSubroutes))))
	add(http.MethodDelete, "/watchlists/", jwtService.Middleware(auth.RequireRoles("CLIENT_BASIC", "CLIENT_TRADING", "BASIC", "AGENT", "SUPERVISOR", "ADMIN")(http.HandlerFunc(handlers.WatchlistSubroutes))))
	add(http.MethodGet, "/stocks/internal/dividend-data", jwtService.Middleware(auth.RequireRoles("SERVICE")(http.HandlerFunc(handlers.DividendData))))
