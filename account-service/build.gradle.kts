...
dependencies {
	...
	// PR_16 C16.1: phantom test starter koord uklonjeni — ne postoje u Maven Central.
	// `spring-boot-starter-test` tranzitivno donosi JUnit 5, Mockito, AssertJ, Spring Test
	// (pokriva MockMvc, RabbitMQ test infrastruktura, JPA test slice). Za Spring Security
	// testiranje koristi se `spring-security-test`.
