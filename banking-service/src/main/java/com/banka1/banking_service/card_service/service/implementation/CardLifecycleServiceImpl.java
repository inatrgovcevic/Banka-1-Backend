...
import com.banka1.banking_service.card_service.dto.card_management.response.CardDetailDTO;
import com.banka1.banking_service.card_service.dto.card_management.response.CardInternalSummaryDTO;
import com.banka1.banking_service.card_service.dto.card_management.response.CardSummaryDTO;
...
public class CardLifecycleServiceImpl implements CardLifecycleService {
    ...
    public AccountNotificationContextDto getAccountContext(String accountNumber) {
        InternalAccountDetailsDto details = accountService.getAccountDetails(accountNumber);
    ...
    private List<ClientNotificationRecipientDto> resolveNotificationRecipients(Card card) {
        ...
        if (card.getAuthorizedPersonId() != null) {
            ...
            AccountNotificationContextDto accountContext = getNotificationContext(card.getAccountNumber());
