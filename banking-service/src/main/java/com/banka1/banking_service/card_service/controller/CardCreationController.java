...
public class CardCreationController {
    ...
    private AccountNotificationContextDto loadAccountContext(String accountNumber) {
        ...
        var details = accountService.getAccountDetails(accountNumber.strip());
        return new AccountNotificationContextDto(
                details == null || details.accountType() == null
                        ? null
                        : com.banka1.banking_service.card_service.domain.enums.AccountOwnershipType.valueOf(details.accountType()),
