...
import com.banka1.banking_service.credit_service.domain.InterestRateStore;
...
import com.banka1.banking_service.credit_service.dto.response.*;
...
public class LoanServiceImplementation implements LoanService {
    ...
    public LoanRequestResponseDto request(Jwt jwt, LoanRequestDto loanRequestDto) {
        ...
        var accountDetailsResponseDto=accountService.getAccountDetails(loanRequestDto.getAccountNumber());
    ...
    public String confirmation(Jwt jwt, Long id,Status status) {
        ...
        if(status==Status.APPROVED)
        {
            ...
            accountService.transactionFromBank(new com.banka1.banking_service.account_service.dto.request.BankPaymentDto(null,loanRequest.getAccountNumber(),loanRequest.getAmount()));
            Loan loan=new Loan();
    ...
    public void cronForRates()
    {
        ...
        for(Installment x:list) {
            try {
                accountService.transactionFromBank(new com.banka1.banking_service.account_service.dto.request.BankPaymentDto(x.getLoan().getAccountNumber(),null, x.getInstallmentAmount()));
            }
